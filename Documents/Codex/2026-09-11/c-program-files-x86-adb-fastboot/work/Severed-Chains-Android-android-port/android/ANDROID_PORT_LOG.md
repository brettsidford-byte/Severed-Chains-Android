...
2026-09-11: Added optional GitHub Actions shared-keystore signing. Builds use encrypted repository secrets when configured; local builds and workflows without those secrets retain the existing debug signing behavior.
