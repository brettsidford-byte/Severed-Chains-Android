...
// Compact explicit varyings avoid mixed interface-block corruption on Mali. The
// packed control words remain exactly representable by the target's highp floats.
out vec2 tmdUv;
