...
public abstract class QueuedModel<Options extends ShaderOptionsBase, T extends QueuedModel<Options, T>> {
  ...
  DepthComparator opaqueDepthComparator;
  DepthComparator translucentDepthComparator;
  ...
  public T opaqueDepthComparator(final DepthComparator comparator) {
    this.opaqueDepthComparator = comparator;
    //noinspection unchecked
    return (T)this;
  }

  public T translucentDepthComparator(final DepthComparator comparator) {
  ...
  void acquire(final Obj obj, final int sequence) {
    ...
    this.opaqueDepthComparator = DepthComparator.LESS;
    this.translucentDepthComparator = DepthComparator.LESS_THAN_OR_EQUAL;
  }
