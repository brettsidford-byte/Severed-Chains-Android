...
/** Platform-neutral registry and lifecycle owner for renderer resources. */
public final class ShaderManager {
  ...
  public static void reload() throws IOException {
    for(final Shader<?> shader : shaders.values()) shader.reload();
  }

  public static void delete() {
    for(final Shader<?> shader : shaders.values()) shader.delete();
    for(final ShaderUniformBuffer buffer : uniformBuffers.values()) buffer.delete();
    shaders.clear();
